...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] != true) {
    ...
    echo '<script type="text/javascript"> window.location="/ediscuss/index.php/login";</script>';
}
// print_r($_SESSION);
?>
<!DOCTYPE html>
                ...
                <div class="post">
                    ...
                    ?>
                        ...
                        <div class="post-title">
                            ...
                            <h3><a href="search.php?search=<?php echo $row['queId']; ?>"><?php echo $row['queTitle']; ?></a></h3>
